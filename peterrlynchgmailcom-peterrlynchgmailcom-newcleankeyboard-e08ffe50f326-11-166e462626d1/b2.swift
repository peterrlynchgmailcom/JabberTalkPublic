...
class b2ViewController: UIViewController  {
    ...
    @IBAction func B1(_ sender: UIButton) {
        ...
        let defaults = UserDefaults.standard
        defaults.set(B1.currentTitle!, forKey: "b2b1")
        
        
        defaults.set(Date(), forKey: "b2b1t")
    ...
    @IBAction func C1(_ sender: UIButton) {
        ...
        let defaults = UserDefaults.standard
        defaults.set(C1.currentTitle!, forKey: "b2c1")
        
        
        defaults.set(Date(), forKey: "b2c1t")
        let myValue:NSString = TextField.text! as NSString
    ...
    @IBAction func D1(_ sender: UIButton) {
        ...
        let defaults = UserDefaults.standard
        defaults.set(D1.currentTitle!, forKey: "b2d1")
        
        
        defaults.set(Date(), forKey: "b2d1t")
        let myValue:NSString = TextField.text! as NSString
    ...
    @IBAction func a2(_ sender: UIButton) {TextField.text = TextField.text! + a2.currentTitle! + String(" ")
        let defaults = UserDefaults.standard
        defaults.set(a2.currentTitle!, forKey: "b2a2")
        
        
        defaults.set(Date(), forKey: "b2a2t")
        let myValue:NSString = TextField.text! as NSString
    ...
    @IBAction func b2(_ sender: UIButton) {TextField.text = TextField.text! + b2.currentTitle! + String(" ")
        let defaults = UserDefaults.standard
        defaults.set(b2.currentTitle!, forKey: "b2b2")
        
        
        defaults.set(Date(), forKey: "b2b2t")
        let myValue:NSString = TextField.text! as NSString
    ...
    @IBAction func c2(_ sender: UIButton) {TextField.text = TextField.text! + c2.currentTitle! + String(" ")
        let defaults = UserDefaults.standard
        defaults.set(c2.currentTitle!, forKey: "b2c2")
        
        
        defaults.set(Date(), forKey: "b2c2t")
        let myValue:NSString = TextField.text! as NSString
    ...
    @IBAction func d2(_ sender: UIButton) {TextField.text = TextField.text! + d2.currentTitle! + String(" ")
        let defaults = UserDefaults.standard
        defaults.set(d2.currentTitle!, forKey: "b2d2")
        
        
        defaults.set(Date(), forKey: "b2d2t")
        let myValue:NSString = TextField.text! as NSString
    ...
    @IBAction func a3(_ sender: UIButton) {TextField.text = TextField.text! + a3.currentTitle! + String(" ")
        let defaults = UserDefaults.standard
        defaults.set(a3.currentTitle!, forKey: "b2a3")
        
        
        defaults.set(Date(), forKey: "b2a3t")
        let myValue:NSString = TextField.text! as NSString
    ...
    @IBAction func b3(_ sender: UIButton) {TextField.text = TextField.text! + b3.currentTitle! + String(" ")
        let defaults = UserDefaults.standard
        defaults.set(b3.currentTitle!, forKey: "b2b3")
        
        
        defaults.set(Date(), forKey: "b2b3t")
        let myValue:NSString = TextField.text! as NSString
    ...
    @IBAction func c3(_ sender: UIButton) {TextField.text = TextField.text! + c3.currentTitle! + String(" ")
        let defaults = UserDefaults.standard
        defaults.set(c3.currentTitle!, forKey: "b2c3")
        
        
        defaults.set(Date(), forKey: "b2c3t")
        let myValue:NSString = TextField.text! as NSString
    ...
    @IBAction func d3(_ sender: UIButton) {TextField.text = TextField.text! + d3.currentTitle! + String(" ")
        let defaults = UserDefaults.standard
        defaults.set(d3.currentTitle!, forKey: "b2d3")
        
        
        defaults.set(Date(), forKey: "b2d3t")
        let myValue:NSString = TextField.text! as NSString
    ...
    @IBAction func a4(_ sender: UIButton) {TextField.text = TextField.text! + a4.currentTitle! + String(" ")
        let defaults = UserDefaults.standard
        defaults.set(a4.currentTitle!, forKey: "b2a4")
        
        defaults.set(Date(), forKey: "b2a4t")
        let myValue:NSString = TextField.text! as NSString
    ...
    @IBAction func b4(_ sender: UIButton) {TextField.text = TextField.text! + b4.currentTitle! + String(" ")
        let defaults = UserDefaults.standard
        defaults.set(b4.currentTitle!, forKey: "b2b4")
        
        defaults.set(Date(), forKey: "b2b4t")
        let myValue:NSString = TextField.text! as NSString
    ...
    @IBAction func c4(_ sender: UIButton) {TextField.text = TextField.text! + c4.currentTitle! + String(" ")
        let defaults = UserDefaults.standard
        defaults.set(c4.currentTitle!, forKey: "b2c4")
        
        defaults.set(Date(), forKey: "b2c4t")
        let myValue:NSString = TextField.text! as NSString
    ...
    @IBAction func d4(_ sender: UIButton) {TextField.text = TextField.text! + d4.currentTitle! + String(" ")
        let defaults = UserDefaults.standard
        defaults.set(d4.currentTitle!, forKey: "b2d4")
        
        defaults.set(Date(), forKey: "b2d4t")
        let myValue:NSString = TextField.text! as NSString
    ...
    @IBAction func a2p(_ sender: UILongPressGestureRecognizer) { a2.setTitle(TextField.text!, for: UIControlState())
        ...
        defaults.set(a2.titleLabel?.text, forKey: "b2a2")
    }
    ...
    @IBAction func b2p(_ sender: UILongPressGestureRecognizer) {b2.setTitle(TextField.text!, for: UIControlState())
        ...
        defaults.set(b2.titleLabel?.text, forKey: "b2b2")
    ...
    @IBAction func c2p(_ sender: UILongPressGestureRecognizer) {c2.setTitle(TextField.text!, for: UIControlState())
        ...
        defaults.set(c2.titleLabel?.text, forKey: "b2c2")
    ...
    @IBAction func d2p(_ sender: UILongPressGestureRecognizer) {d2.setTitle(TextField.text!, for: UIControlState())
        ...
        defaults.set(d2.titleLabel?.text, forKey: "b2d2")
    ...
    @IBAction func a3p(_ sender: UILongPressGestureRecognizer) {a3.setTitle(TextField.text!, for: UIControlState())
        ...
        defaults.set(a3.titleLabel?.text, forKey: "b2a3")
    }
    ...
    @IBAction func b3p(_ sender: UILongPressGestureRecognizer) {b3.setTitle(TextField.text!, for: UIControlState())
        ...
        defaults.set(b3.titleLabel?.text, forKey: "b2b3")
    }
    ...
    @IBAction func c3p(_ sender: UILongPressGestureRecognizer) {c3.setTitle(TextField.text!, for: UIControlState())
        ...
        defaults.set(c3.titleLabel?.text, forKey: "b2c3")
    }
    ...
    @IBAction func d3p(_ sender: UILongPressGestureRecognizer) {d3.setTitle(TextField.text!, for: UIControlState())
        ...
        defaults.set(d3.titleLabel?.text, forKey: "b2d3")
    }
    ...
    @IBAction func a4p(_ sender: UILongPressGestureRecognizer) {a4.setTitle(TextField.text!, for: UIControlState())
        ...
        defaults.set(a4.titleLabel?.text, forKey: "b2a4")
    }
    ...
    @IBAction func b4p(_ sender: UILongPressGestureRecognizer) {b4.setTitle(TextField.text!, for: UIControlState())
        ...
        defaults.set(b4.titleLabel?.text, forKey: "b2b4")
    }
    ...
    @IBAction func c4p(_ sender: UILongPressGestureRecognizer) {c4.setTitle(TextField.text!, for: UIControlState())
        ...
        defaults.set(c4.titleLabel?.text, forKey: "b2c4")
    }
    ...
    @IBAction func d4p(_ sender: UILongPressGestureRecognizer) {d4.setTitle(TextField.text!, for: UIControlState())
        ...
        defaults.set(d4.titleLabel?.text, forKey: "b2d4")
    }
    ...
    override func viewDidLoad() {
        ...
        //set button fade
        if defaults.object(forKey: "b2b1t") == nil {
            B1.setTitleColor(UIColor.black ,  for: UIControlState())
        }
        if defaults.object(forKey: "b2b1t") != nil {
            let b1lastrun = defaults.object(forKey: "b2b1t") as! Date
        ...
        //set button fade
        if defaults.object(forKey: "b2c1t") == nil {
            C1.setTitleColor(UIColor.black ,  for: UIControlState())
        }
        if defaults.object(forKey: "b2c1t") != nil {
            let b1lastrun = defaults.object(forKey: "b2c1t") as! Date
            let elapsedTime = Date().timeIntervalSince(b1lastrun)
            if elapsedTime > 2592000//if more than 1 month
            {
        ...
        //set button fade
        if defaults.object(forKey: "b2d1t") == nil {
            D1.setTitleColor(UIColor.black ,  for: UIControlState())
        }
        if defaults.object(forKey: "b2d1t") != nil {
            let b1lastrun = defaults.object(forKey: "b2d1t") as! Date
            let elapsedTime = Date().timeIntervalSince(b1lastrun)
            if elapsedTime > 2592000//if more than 1 month
            {
        ...
        //set button fade
        if defaults.object(forKey: "b2a2t") == nil {
            a2.setTitleColor(UIColor.black ,  for: UIControlState())
        }
        if defaults.object(forKey: "b2a2t") != nil {
            let b1lastrun = defaults.object(forKey: "b2a2t") as! Date
            let elapsedTime = Date().timeIntervalSince(b1lastrun)
            if elapsedTime > 2592000//if more than 1 month
            {
        ...
        //set button fade
        if defaults.object(forKey: "b2b2t") == nil {
            b2.setTitleColor(UIColor.black ,  for: UIControlState())
        }
        if defaults.object(forKey: "b2b2t") != nil {
            let b1lastrun = defaults.object(forKey: "b2b2t") as! Date
            let elapsedTime = Date().timeIntervalSince(b1lastrun)
            if elapsedTime > 2592000//if more than 1 month
            {
        ...
        //set button fade
        if defaults.object(forKey: "b2c2t") == nil {
            c2.setTitleColor(UIColor.black ,  for: UIControlState())
        }
        if defaults.object(forKey: "b2c2t") != nil {
            let b1lastrun = defaults.object(forKey: "b2c2t") as! Date
            let elapsedTime = Date().timeIntervalSince(b1lastrun)
            if elapsedTime > 2592000//if more than 1 month
            {
        ...
        //set button fade
        if defaults.object(forKey: "b2d2t") == nil {
            d2.setTitleColor(UIColor.black ,  for: UIControlState())
        }
        if defaults.object(forKey: "b2d2t") != nil {
            let b1lastrun = defaults.object(forKey: "b2d2t") as! Date
            let elapsedTime = Date().timeIntervalSince(b1lastrun)
            if elapsedTime > 2592000//if more than 1 month
            {
        ...
        //set button fade
        if defaults.object(forKey: "b2a3t") == nil {
            a3.setTitleColor(UIColor.black ,  for: UIControlState())
        }
        if defaults.object(forKey: "b2a3t") != nil {
            let b1lastrun = defaults.object(forKey: "b2a3t") as! Date
            let elapsedTime = Date().timeIntervalSince(b1lastrun)
            if elapsedTime > 2592000//if more than 1 month
            {
        ...
        //set button fade
        if defaults.object(forKey: "b2b3t") == nil {
            b3.setTitleColor(UIColor.black ,  for: UIControlState())
        }
        if defaults.object(forKey: "b2b3t") != nil {
            let b1lastrun = defaults.object(forKey: "b2b3t") as! Date
            let elapsedTime = Date().timeIntervalSince(b1lastrun)
            if elapsedTime > 2592000//if more than 1 month
            {
        ...
        //set button fade
        if defaults.object(forKey: "b2c3t") == nil {
            c3.setTitleColor(UIColor.black ,  for: UIControlState())
        }
        if defaults.object(forKey: "b2c3t") != nil {
            let b1lastrun = defaults.object(forKey: "b2c3t") as! Date
            let elapsedTime = Date().timeIntervalSince(b1lastrun)
            if elapsedTime > 2592000//if more than 1 month
            {
        ...
        //set button fade
        if defaults.object(forKey: "b2d3t") == nil {
            d3.setTitleColor(UIColor.black ,  for: UIControlState())
        }
        if defaults.object(forKey: "b2d3t") != nil {
            let b1lastrun = defaults.object(forKey: "b2d3t") as! Date
            let elapsedTime = Date().timeIntervalSince(b1lastrun)
            if elapsedTime > 2592000//if more than 1 month
            {
        ...
        //set button fade
        if defaults.object(forKey: "b2a4t") == nil {
            a4.setTitleColor(UIColor.black ,  for: UIControlState())
        }
        if defaults.object(forKey: "b2a4t") != nil {
            let b1lastrun = defaults.object(forKey: "b2a4t") as! Date
            let elapsedTime = Date().timeIntervalSince(b1lastrun)
            if elapsedTime > 2592000//if more than 1 month
            {
        ...
        //set button fade
        if defaults.object(forKey: "b2b4t") == nil {
            b4.setTitleColor(UIColor.black ,  for: UIControlState())
        }
        if defaults.object(forKey: "b2b4t") != nil {
            let b1lastrun = defaults.object(forKey: "b2b4t") as! Date
            let elapsedTime = Date().timeIntervalSince(b1lastrun)
            if elapsedTime > 2592000//if more than 1 month
            {
        ...
        //set button fade
        if defaults.object(forKey: "b2c4t") == nil {
            c4.setTitleColor(UIColor.black ,  for: UIControlState())
        }
        if defaults.object(forKey: "b2c4t") != nil {
            let b1lastrun = defaults.object(forKey: "b2c4t") as! Date
            let elapsedTime = Date().timeIntervalSince(b1lastrun)
            if elapsedTime > 2592000//if more than 1 month
            {
        ...
        //set button fade
        if defaults.object(forKey: "b2d4t") == nil {
            d4.setTitleColor(UIColor.black ,  for: UIControlState())
        }
        if defaults.object(forKey: "b2d4t") != nil {
            let b1lastrun = defaults.object(forKey: "b2d4t") as! Date
            let elapsedTime = Date().timeIntervalSince(b1lastrun)
            if elapsedTime > 2592000//if more than 1 month
            {
        ...
        if defaults.string(forKey: "b2b1") != nil {
            B1.setTitle(defaults.string(forKey: "b2b1"), for: UIControlState())
        }
        if defaults.string(forKey: "b2c1") != nil {
            C1.setTitle(defaults.string(forKey: "b2c1"), for: UIControlState())
        }
        if defaults.string(forKey: "b2d1") != nil {
            D1.setTitle(defaults.string(forKey: "b2d1"), for: UIControlState())
        }
        
        
        if defaults.string(forKey: "b2a2") != nil {
            a2.setTitle(defaults.string(forKey: "b2a2"), for: UIControlState())
        }
        if defaults.string(forKey: "b2b2") != nil {
            b2.setTitle(defaults.string(forKey: "b2b2"), for: UIControlState())
        }
        if defaults.string(forKey: "b2c2") != nil {
            c2.setTitle(defaults.string(forKey: "b2c2"), for: UIControlState())
        }
        if defaults.string(forKey: "b2d2") != nil {
            d2.setTitle(defaults.string(forKey: "b2d2"), for: UIControlState())
        }
        
        
        if defaults.string(forKey: "b2a3") != nil {
            a3.setTitle(defaults.string(forKey: "b2a3"), for: UIControlState())
        }
        if defaults.string(forKey: "b2b3") != nil {
            b3.setTitle(defaults.string(forKey: "b2b3"), for: UIControlState())
        }
        if defaults.string(forKey: "b2c3") != nil {
            c3.setTitle(defaults.string(forKey: "b2c3"), for: UIControlState())
        }
        if defaults.string(forKey: "b2d3") != nil {
            d3.setTitle(defaults.string(forKey: "b2d3"), for: UIControlState())
        }
        
        
        if defaults.string(forKey: "b2a4") != nil {
            a4.setTitle(defaults.string(forKey: "b2a4"), for: UIControlState())
        }
        if defaults.string(forKey: "b2b4") != nil {
            b4.setTitle(defaults.string(forKey: "b2b4"), for: UIControlState())
        }
        if defaults.string(forKey: "b2c4") != nil {
            c4.setTitle(defaults.string(forKey: "b2c4"), for: UIControlState())
        }
        if defaults.string(forKey: "b2d4") != nil {
            d4.setTitle(defaults.string(forKey: "b2d4"), for: UIControlState())
        }
